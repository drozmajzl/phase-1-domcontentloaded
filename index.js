...
// Note: Using the innerText (Links to an external site.) property to modify DOM element content will not work for this lab. 
// Use textContent (Links to an external site.) or innerHTML (Links to an external site.) instead.
